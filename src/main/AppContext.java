...
public class AppContext {
    ...
    static void go(String key) { cl.show(root, key); }
    ...
    static String priceLabel(PriceType pt) {
        switch (pt) {
            case MORNING_PRICE: return "10,000원";
            case GENERAL_PRICE: return "15,000원";
            case NIGHT_PRICE:   return "12,000원";
            default:            return "";
        }
    }
    ...
    static int unitPrice(PriceType pt) {
        switch (pt) {
            case MORNING_PRICE: return 10000;
            case GENERAL_PRICE: return 15000;
            case NIGHT_PRICE:   return 12000;
            default:            return 0;
        }
    }
